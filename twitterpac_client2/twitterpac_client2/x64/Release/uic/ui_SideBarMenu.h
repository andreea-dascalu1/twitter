...
public:
    ...
    void setupUi(QWidget *SideBarMenu)
    {
        ...
        pushButton_8->setGeometry(QRect(0, 250, 91, 31));
...
"}"));
        ...
        pushButton_4->setGeometry(QRect(0, 190, 91, 31));
...
"}"));
        ...
        pushButton_9->setGeometry(QRect(0, 300, 91, 31));
...
""));
    ...
    void retranslateUi(QWidget *SideBarMenu)
    {
        ...
        pushButton_4->setText(QApplication::translate("SideBarMenu", "Messages", nullptr));
