...
public:
    ...
    void setupUi(QWidget *Retweet)
    {
        ...
        Retweet->resize(604, 1756);
        Retweet->setMinimumSize(QSize(604, 317));
...
"color:rgb(59, 63, 67);"));
        ...
        sizePolicy.setHeightForWidth(tweet_2->sizePolicy().hasHeightForWidth());
        tweet_2->setSizePolicy(sizePolicy);
        QFont font3;
