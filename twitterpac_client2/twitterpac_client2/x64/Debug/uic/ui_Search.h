...
""));
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 621, 1022));
        QSizePolicy sizePolicy1(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(scrollAreaWidgetContents_4->sizePolicy().hasHeightForWidth());
        scrollAreaWidgetContents_4->setSizePolicy(sizePolicy1);
...
""));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 621, 1022));
...
""));
        ...
        verticalLayoutWidget_3->setGeometry(QRect(0, 0, 601, 211));
